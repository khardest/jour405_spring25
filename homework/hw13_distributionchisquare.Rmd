---
title: "hw13_distributionchisquare"
...
Overall I do think they are meaningful as we learned last class that even a small difference can indicate meaningful differences. Since 3 categories have differences of 10 or more I would predict a meaningful difference between expected and observed. 
...
Since the chi square statistic is 11.667 and the critical value is 9.488 and 11.667>9.488 we reject the null hypothesis.
...
The most significant discrepancies are that 20 more students earned As than expected, 20 fewer students earned Cs than expected and 10 fewer students failed than expected.

I could ask if there was a curve that caused more people to get higher grades, if there was any extra-credit offered, or if there werre any new tutoring programs or review sessions that wouldve caused students to perform better.
