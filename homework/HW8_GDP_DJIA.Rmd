...
There is a strong positive correlation between DJIA and GDP. The correlation coefficient is .95 which is very close to 1, which is the highest level of correlation. Also, the scatter plot shows this correlation as all of the points appear to hug the line of best fit, which has a clearly positive slope. As DJIA and GDP increases the points seem to spread out more and hug the line less.
