...
Evidence shows that the new light rail line could've had an impact on the housing prices in the neighborhood. While all of the new houses were sold for higher than the average house price before the new line, the new line may not be the only reason these prices increased. While statistics and data support the idea that prices have increased due to the new transit line, but there is no way to guarantee this is actually the case. There is support for the officials claim, but no real proof.
