...
The range is 2.8088, which I got from subtracting the max from the min

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?

A respondent with a weight of .23 is a type of person who is too heavily represented in the poll and a person witha weight of 3.04 isnt represented enough

3. Why might some respondents be weighted more heavily than others?

Someone may be weighted more heavily if they are hard reach for example if they only have a landline
...
The "rarely/never" voter category shows the biggest difference between weighted and unweighted results

2. How might these differences affect reporting on likely voter turnout?

Reporting on likely voter turnout may be hard to predict/be inaccurate because the rarely/never voters can be very unpredictable in terms of responding to surveys. This means that it is possible for them to be over/underrepresented in the polls. Also if reporters ignore the people who say they arent going to vote and then they all come and vote anyways, the results can turn out completely different from the poll predictions.
...
These differences exist because some people are more likely to respond while others are less likely which can cause problems with trying to depict real world voter proportions. This tells us that rarely/never voters were likely over represented in terms of if they were going to vote because the percentages changed the most after weighting. 
