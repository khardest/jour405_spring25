...
The correlation calculations indicate that the relationship is positive, but only by .018 which essentially means they are 99% not related. This means there is essentially no correlation between fouls and goal differential. The scatterplot further illustrates this to me because the dots show essentially no pattern and if I were to draw a positive line through the data, the points wouldnt hug the line at all.Instead the line of best fit is essentially just straight across the data in the plot.
