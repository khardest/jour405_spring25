...
Private colleges typically have students with the highest SAT scores, and community colleges typically have students with the lowest scores, when looking at the mean and median. Students at private colleges also have scores that vary the least, based on standard deviation from the mean. Also, private and public schools had students who were able to score perfectly at a 1600, where the highest score for community colleges was about a 1390. 
...
Yes there is a statistically significant difference in SAT scores across college types. Based on the F value of 284.3 from the ANOVA test with a p value of .001 we can assume these differences aren't coincidental. 
2. Which specific college types differ from each other?

Based on the Tukey test, all of the types showed significant differences. Private schools scored higher than community colleges, public school scored higher than community colleges and public schools scored lower than private schools. 
3. How large are these differences?

These differences are pretty large as Private schools score better than community colleges by over 360 points and public schools outscore community colleges by almost 300 points. Additionally private schools outperform public schools by over 70 points.
...
Students at private colleges scored higher on the SAT, study finds. 

Private college students scored significantly higher on the SAT than those at public and community colleges. The study found that private college students scored an average of 367 points higher than community college students, and 74 points higher than students at public colleges. The findings suggest that the difference in scores is not a coincidence.  
