...
I think the above weird line would fall at about above 15 calls and the below weird line would fall at 5 calls. 
...
The location of the lines are pretty similar, as my above line was at 15 and based on the unusual days the line seems to be about 17. With the below line I said it would be at about 5 and the unusual days show the line would be at about 4.
...
I would say that the day with the highest z-score is the day that had the largest difference of 911 calls in comparison to the mean daily number of 911 calls that year.
...
One potential angle for reporting could be looking at why the 911 calls seem to surge in the warmer months and decrease in the colder months as we can see on the monthly line graph that seems what to happen. For this angle I would try to get recordings of these 911 calls to see if that gave me any evidence or try to get in contact with those familiar with the drug industry. 

With a similar approach, I could also look into why certain days of the week have more 911 calls than others. Saturdays and Fridays make sense, but why are there so many calls on Monday? For this angle I would try and talk to police and operators for insight along with trying to get recordings of the 911 calls. 
