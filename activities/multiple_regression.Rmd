...
I think this is a useful model. It shows overall significance as the F-statistic of 15.44 and the p value of 4.06e-06 show the model is statistically significant. The adjusted r squared also shows the model xan explain over half of the variability in wins. It also shows us that points scored have a statistically significant positive effect on wins.I think this model gives us a pretty good idea of what impacts win variability. 
...
Points scored has the most impact on wins, as the correlation is .70, which is very strong and higher than the correlation with wins and the other two. Since yards gained showed only a moderate correlation and was not significant in the regression showing it may not be the best factor in terms of predicting wins.
...
In terms of a team's season or even a game, we could predict if they will win based on their number of takeaways and points scored. We have learned that points scored and takeaways have the biggest impact on if a time will win. Therefore, if a team is consistently scoring many points and getting many takeaways then it is likely that they will win games. 
